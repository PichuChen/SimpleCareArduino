...
void setup()
{
    ...
    _advertisement.configAsConnectableDevice("Simple Care 4");
...
SubTopic = "hello/world";
  ...
  sprintf (buf1, "%s=%s", LBLECentral.getAddress(i).c_str(), LBLECentral.getName(i).c_str()); 
  sprintf (buf2, "%03i", LBLECentral.getRSSI(i));
  Serial.print("TXPower: %d");
  Serial.print(LBLECentral.getTxPower(i));
